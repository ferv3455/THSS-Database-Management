 ...
 *
 * <p>This exception is thrown when a discrepancy occurs between two ComparerType instances. The
 * detailed message of the exception provides information about the types that do not match.
 */
public class TypeMisMatchException extends RuntimeException {
   ...
   *
   * <p>The message contains the names of the ComparerTypes that do not match.
   *
  ...
  public String getMessage() {
    return "Exception: Type 1 "
        + getComparerTypeName(this.type1)
        + " and Type 2 "
        + getComparerTypeName(this.type2)
        + " do not match!";
  }
