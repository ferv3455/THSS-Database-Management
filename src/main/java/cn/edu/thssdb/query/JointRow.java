...
public class JointRow extends Row {
    ...
    /**
     * Splits a column name in the format "TableName.ColumnName" into an array containing the table name and column name.
     *
     ...
     * @throws AttributeCollisionException   if the column name is ambiguous (appears in multiple tables).
     */
    public Comparer getColumnComparer(String column_name) throws AttributeNotFoundException, AttributeCollisionException {
        int index = -1; // 列索引
